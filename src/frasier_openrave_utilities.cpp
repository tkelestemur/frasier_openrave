...
OpenRAVE::Transform FRASIEROpenRAVE::ROSTransformToORTransform(geometry_msgs::Transform &transform) {
    OpenRAVE::Transform or_transform(OpenRAVE::Vector(transform.rotation.w,
                                                    transform.rotation.x,
                                                    transform.rotation.y,
                                                    transform.rotation.z),
                                   OpenRAVE::Vector(transform.translation.x,
...
void FRASIEROpenRAVE::drawPoints(std::vector<OpenRAVE::Vector> &points) {
    ...
    graph_handles_.push_back(
            env_->plot3(&points_v.front(), num_points, 3 * sizeof(float), point_size, OpenRAVE::Vector(0, 1, 0, 1)));
...
void FRASIEROpenRAVE::drawPoint(OpenRAVE::Vector &point) {
    ...
    graph_handles_.push_back(
            env_->plot3(&point_v.front(), num_points, 3 * sizeof(float), point_size, OpenRAVE::Vector(0, 1, 0, 1)));
